...
def upload():
    ...
    candidate_path = os.path.join(app.config["UPLOAD_FOLDER"], candidates.filename)
    ...
    # Read Candidates
    # -----------------------------
    parser = CandidateParser(Path(candidate_path))

    candidate_list = list(parser.read_candidates())
    ...
    for score, candidate in top100:
        ...
        display_candidates.append({
            ...
            "role": profile.get("current_title", "Not Available"),

            "company": profile.get("current_company", "Not Available"),
